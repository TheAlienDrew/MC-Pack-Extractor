...
if [[ $(7z --help >/dev/null 2>&1) ]]; then
	echo -e "Unable to run because 7-Zip isn't installed."
	echo -e "7-Zip can be installed by running \"sudo apt install p7zip\"\n"
...
7z a "$PWD/MC$version.zip" "/tmp/mctemp/*" >/dev/null 2>&1
echo -e "Done.\n\nCleaning up temporary files..."
rm -rf "/tmp/mctemp"
echo -e "Done.\n"
echo -e "Resource/Texture pack located at $PWD/MC$version.zip\n"
read -p "Press [Enter] key to continue..." && exit
